 ...
 */
public class FireCellLightning implements Cell {
			...
			for ( int col = 0 ; col < gridCols_ ; col++ ) {
				if ( grid_[row][col] == FireState.EMPTY ) {
					...
					if ( (((row > 0 && grid_[row - 1][col] == FireState.BURNING)
					    ...
					    || (Math.random() < probLightning_ * probcatch_) ) {
