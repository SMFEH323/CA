 ...
 */
public class FireAppRandom extends Application {
	...
	private static final double probBurning_ = .20;
	...
	public void start ( Stage stage ) throws Exception {
		stage.setTitle("Fire! (Random)");

		controller_ =
		    new Controller(new FireCellRandom(GRIDROWS,GRIDCOLS,probcatch_,
