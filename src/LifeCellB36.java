 ...
 */
public class LifeCellB36 implements Cell {
	...
	public LifeCellB36 ( int gridRows, int gridCols ) {
		gridRows_ = gridRows;
		gridCols_ = gridCols;
	}
	...
	public void initSim () {
		...
		grid_[midRow][midCol + 2] = LifeState.ALIVE;
		grid_[midRow - 1][midCol + 2] = LifeState.ALIVE;
		grid_[midRow - 2][midCol + 2] = LifeState.ALIVE;
		grid_[midRow][midCol - 2] = LifeState.ALIVE;
		grid_[midRow + 1][midCol - 2] = LifeState.ALIVE;
		grid_[midRow + 2][midCol - 2] = LifeState.ALIVE;
		grid_[midRow + 2][midCol] = LifeState.ALIVE;
		grid_[midRow + 2][midCol - 1] = LifeState.ALIVE;
		grid_[midRow - 2][midCol] = LifeState.ALIVE;
		grid_[midRow - 2][midCol + 1] = LifeState.ALIVE;
